	...
	!(function () {
				...
				(Array.prototype.indexOf = function (t) {
					...
					if (
						...
						arguments.length > 1 &&
							...
							e !== e
								? (e = 0)
								: 0 !== e && e !== 1 / 0 && e !== -(1 / 0) && (e = (e > 0 || -1) * Math.floor(Math.abs(e)))),
						e >= i)
					)
						return -1
		...
		(e = function (a, i, o) {
			var r = null,
				...
				m = [],
				g = -1
			if (((u = o || t.document), (s = arguments[3]) && (s = 'boolean' == typeof s), 'string' == typeof a))
		...
		(e.use = function (t) {
			e.Base.prototype.callActions.call(e, 'beforeUse', arguments),
				'function' == typeof t && 'mixitup-extension' === t.TYPE
					? 'undefined' == typeof e.extensions[t.NAME] && (t(e), (e.extensions[t.NAME] = t))
		...
		(n = {
			...
			handleExtendError: function (t, n) {
				...
				if (t instanceof TypeError && (i = a.exec(t.message))) {
					...
					throw (
						(u > 1 && (s = e.messages.errorConfigInvalidPropertySuggestion({ probableMatch: l })),
						(r = e.messages.errorConfigInvalidProperty({ erroneous: o, suggestion: s })),
						new TypeError(r))
					)
				}
				throw t
			...
			off: function (t, e, n) {
				t &&
					(t.removeEventListener
						...
						: t.detachEvent && (t.detachEvent('on' + e, t[e + n]), (t[e + n] = null)))
			},
			...
			isElement: function (e, n) {
				return (
					...
					!!(t.HTMLElement && e instanceof t.HTMLElement) ||
						!!(n.defaultView && n.defaultView.HTMLElement && e instanceof n.defaultView.HTMLElement) ||
			...
			createElement: function (e, n) {
				var a = null,
					i = null
				for (
					n = n || t.document, a = n.createDocumentFragment(), i = n.createElement('div'), i.innerHTML = e.trim();
					i.firstChild;
			...
			isVisible: function (e) {
				...
				return (
					!!e.offsetParent ||
					((n = t.getComputedStyle(e)), 'fixed' === n.position && 'hidden' !== n.visibility && '0' !== n.opacity)
				)
			},
			seal: function (t) {
			...
			compareVersions: function (t, e) {
				...
				for (r = 0; r < n.length; r++) {
					if (
						((i = parseInt(n[r].replace(/[^\d.]/g, ''))), (o = parseInt(a[r].replace(/[^\d.]/g, '') || 0)), o < i)
					)
						return !1
					if (o > i) return !0
				}
		...
		n.extend(e.Control.prototype, {
			...
			init: function (t, n, a) {
				var i = this
				if ((this.callActions('beforeInit', arguments), (i.el = t), (i.type = n), (i.selector = a), i.selector))
					i.status = 'live'
				else
			...
			handleClick: function (t) {
				...
				if (
					...
					(o = a.bound[0]),
					(i = a.selector
						? n.closestParent(t.target, o.config.selectors.control + a.selector, !0, o.dom.document)
						: a.el),
					!i)
				)
				...
				for (
					u = a.callFilters('commandsHandleClick', u, arguments), a.pending = a.bound.length, f = 0;
					(o = a.bound[f]);
					f++
				)
					(l = u[f]),
						l &&
							...
							e.events.fire(
								'mixClick',
								o.dom.container,
								{ state: o.state, instance: o, originalEvent: t, control: o.lastClicked },
								o.dom.document,
							),
							('function' == typeof o.config.callbacks.onMixClick &&
								((s = o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o)), s === !1)) ||
		...
		n.extend(e.Mixer.prototype, {
			...
			attach: function (a, i, o, r) {
				...
				s.config.controls.enable &&
					...
					s.updateControls({ filter: s.state.activeFilter, sort: s.state.activeSort })),
					s.parseEffects(),
			...
			indexTargets: function () {
				...
				if (
					...
					(t.dom.targets = t.config.layout.allowNestedTargets
						...
						: n.children(t.dom.container, t.config.selectors.target, t.dom.document)),
				...
				if (t.dom.targets.length) {
					...
					t.dom.parent =
						t.dom.targets[0].parentElement === t.dom.container ? t.dom.container : t.dom.targets[0].parentElement
				}
					...
					for (u = 0; (c = t.collection[u]); u++) {
						...
						;(c.style.display = 'none'),
							...
							n.isElement(c, i.dom.document) &&
								...
								((l = new e.Target()), l.init(c, i), (l.isInDom = !0), i.targets.splice(r, 0, l), r++)
					}
			...
			filterOperation: function (t) {
				var e = this,
					...
					r = -1
				for (
					e.callActions('beforeFilterOperation', arguments), i = t.newFilter.action, r = 0;
					(o = t.newOrder[r]);
					r++
				)
					(n = t.newFilter.collection
						? t.newFilter.collection.indexOf(o.dom.el) > -1
						: '' !== t.newFilter.selector && o.dom.el.matches(t.newFilter.selector)),
			...
			getAttributeValue: function (t, n) {
				...
				return (
					...
					null === i &&
						...
						console.warn(e.messages.warningInconsistentSortingAttributes({ attribute: 'data-' + n })),
			...
			printSort: function (e, a) {
				...
				for (i.callActions('beforePrintSort', arguments), h = 0; (u = o[h]); h++)
					(f = u.dom.el),
						'absolute' !== f.style.position &&
							(n.removeWhitespace(f.previousSibling), f.parentElement.removeChild(f))
				for (
				...
				i.dom.parent.firstChild &&
					...
					s
						? (l.appendChild(t.document.createTextNode(' ')), i.dom.parent.insertBefore(l, s))
			...
			parseEffect: function (t, n, a, i, o) {
				var r = this,
					...
					d = '',
					m = -1
				if ((r.callActions('beforeParseEffect', arguments), 'string' != typeof n))
			...
			goMix: function (a, i) {
				...
				return (
					...
					n.removeClass(
						o.dom.container,
						n.getClassname(o.config.classNames, 'container', o.config.classNames.modifierFailed),
					),
			...
			getStartMixData: function (n) {
				...
				for (
					a.incPadding = 'border-box' === c, a.callActions('beforeGetStartMixData', arguments), l = 0;
					(r = n.show[l]);
					l++
				)
				...
				for (
					e.callActions('beforeSetInter', arguments),
						e.config.animation.clampHeight &&
							((e.dom.parent.style.height = t.startHeight + 'px'), (e.dom.parent.style.overflow = 'hidden')),
						e.config.animation.clampWidth &&
							((e.dom.parent.style.width = t.startWidth + 'px'), (e.dom.parent.style.overflow = 'hidden')),
						i = 0;
					(a = t.toShow[i]);
					i++
				)
			...
			setFinal: function (t) {
				var e = this,
					...
					a = -1
				for (
					e.callActions('beforeSetFinal', arguments), t.willSort && e.printSort(!1, t), a = 0;
					(n = t.toHide[a]);
					a++
				)
					n.hide()
			...
			cleanUp: function (t) {
				...
				t.willSort && (a.targets = t.newOrder),
					...
					t.hasFailed &&
						...
						n.addClass(
							a.dom.container,
							n.getClassname(a.config.classNames, 'container', a.config.classNames.modifierFailed),
						)),
			...
			parseChangeLayoutArgs: function (t) {
				var a = this,
					...
					r = -1
				for (
					i.animate = a.config.animation.enable, i.command = new e.CommandChangeLayout(), r = 0;
					r < t.length;
					r++
				)
					if (((o = t[r]), null !== o))
					...
					;(h[d] = !0),
						(l = a.cache[d]) instanceof e.Target
							? (a.config.data.dirtyCheck &&
									...
									(l.data = s),
									c !== l.dom.el &&
										(l.isInDom && (l.unbindEvents(), a.dom.parent.replaceChild(c, l.dom.el)),
					...
					a.isBusy
						...
						: (l && a.insertTargets(l, c),
						  ...
						  'all' === c.newFilter.selector
								...
								: 'none' === c.newFilter.selector && (c.newFilter.selector = ''),
						  a.filterOperation(c),
						  (c.startContainerClassName = c.startState.activeContainerClassName),
						  r
								? ((c.newContainerClassName = r.containerClassName),
								  c.newContainerClassName !== c.startContainerClassName && (c.willChangeLayout = !0))
				...
				for (o = 0; (n = t.hide[o]); o++)
					n.isShown && n.hide(),
						(i = t.toHide.indexOf(n)) > -1 &&
							((a = t.toHidePosData[i]), n.isShown || n.show(), n.applyTween(a, e))
			},
			insert: function () {
				var t = this,
			...
			forceRender: function () {
				...
				for (a in t.cache)
					(e = t.cache[a]),
						(n = e.render(e.data)),
						n !== e.dom.el &&
							(e.isInDom && (e.unbindEvents(), t.dom.parent.replaceChild(n, e.dom.el)),
		...
		n.extend(e.Target.prototype, {
			...
			render: function (t) {
				...
				return (
					...
					s && 'object' == typeof s && n.isElement(s)
						? (o = s)
						: 'string' == typeof s &&
						  ((r = document.createElement('div')), (r.innerHTML = s), (o = r.firstElementChild)),
			...
			applyStylesIn: function (t) {
				...
				n.callActions('beforeApplyStylesIn', arguments),
					...
					n.mixer.config.animation.animateResizeTargets &&
						('show' !== t.statusChange &&
							((n.dom.el.style.width = a.width + 'px'), (n.dom.el.style.height = a.height + 'px')),
			...
			applyStylesOut: function (t) {
				...
				;(n.mixer.config.animation.nudge || (!n.mixer.config.animation.nudge && 'hide' !== t.statusChange)) &&
					i.push('translate(' + t.posOut.x + 'px, ' + t.posOut.y + 'px)'),
